...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/leonardoa-alves/)

---

## 🎯 Sobre mim

Sou estudante de Engenharia de Software e estou construindo minha base em programação: lógica, C# com Windows Forms, C e desenvolvimento web (HTML, CSS e JavaScript). Aprendo praticando: prefiro escrever o código, quebrar a cabeça com os erros e só depois avançar para o próximo assunto.
...
I'm a Software Engineering student (2nd semester) at UniBrasil Centro Universitário, building my programming foundation with C#, C, HTML, CSS and JavaScript. I learn by doing: writing the code, debugging it, and only then moving on.
...
**Tech:** C#, C, HTML, CSS, JavaScript, Bootstrap, Git, GitHub · **Currently learning:** C# and C
